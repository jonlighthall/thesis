...
Where available, the ion source %and injector 
...
For each experiment, the HELIOS-specific experiment number (\astrosun) is given, starting with one.
...
\begin{landscape}
  ...
  \tablehead{
    ...
    Source&%Injector&
    \multicolumn{1}{c}{Reaction}&\multicolumn{1}{c}{Field}&Directory&Ref.\\
    &\astrosun%HELIOS
    &ATLAS&%spokesman
