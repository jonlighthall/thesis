...
%% Figure packages---------------%-------------------------------
\usepackage{graphicx}
\usepackage{placeins} % \FloatBarrier — keep floats from crossing section boundaries
...
\usepackage{xurl} % allow URLs to break at any character to avoid margin overflow
\usepackage{hyperref}
\hypersetup{
